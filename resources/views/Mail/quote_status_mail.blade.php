    ...
    <style type="text/css">
        ...
        @media (max-width: 480px) {
            ...
            #u_content_menu_3 .v-padding {
                padding: 5px 45px 5px 50px !important;
            }
        }
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{asset('PublicArea/img/logo.webp')}}"
                                                                            alt="Image" title="Image"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 174px;"
                                                                            width="174" />
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:15px 10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    ...
                                                                    Quote Number
                                                                    <strong>{{$quote->quote_number}}</strong> was
                                                                    {{$quote->status == \App\Models\Quote::STATUS['ACCEPTED'] ? 'accepted':'declined'}}
                                                                    by the customer.
                                                                </p>
                                                            </div>
                                    ...
                                    <div style="width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:15px 10px 30px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">
